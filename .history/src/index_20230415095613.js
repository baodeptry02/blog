...
app.post("/search", function(req, res) {
    ...
    res.render('news');
    console.log(req.body.select) /* thằng query parameters đã tích hợp sẵn middleware rồi nên chỉ cần req.query là sẽ lấy đc dữ liệu nhưng mà mấy thằng khác thì chưa nên phải apply body parser vào mới lấy được */
})
